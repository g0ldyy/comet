...
export const newznabPresets = [
  ...
  { endpoint: "https://amenzb.moe/api", id: "amenzb", label: "ameNZB" },
  { endpoint: "https://www.bluraynzb.org/api", id: "bluraynzb", label: "BlurayNZB" },
  { endpoint: "https://clubnzb.com/api", id: "clubnzb", label: "ClubNZB" },
  { endpoint: "https://digitalcarnage.info/api", id: "digital_carnage", label: "Digital Carnage" },
  ...
  { endpoint: "https://fastnzb.com/api", id: "fastnzb", label: "FastNZB" },
  {
    endpoint: "https://www.gingadaddy.com/api",
    id: "gingadaddy",
    label: "GingaDADDY",
  },
  { endpoint: "https://lulunzb.com/api", id: "lulunzb", label: "LuluNZB" },
  ...
  { endpoint: "https://api.omgwtfnzbs.org/api", id: "omgwtfnzbs", label: "omgwtfnzbs" },
  { endpoint: "https://spotweb.me/api", id: "spotweb", label: "spotweb.com" },
  {
